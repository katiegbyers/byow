...
public class GainWorld {
    ...
    private void popUpDirections() {
        ...
        StdDraw.text(WIDTH / 2, HEIGHT / 2 + 5, "YOU   GAINED   A   LIFE");
        StdDraw.setFont(new Font("Monaco", Font.BOLD, 30));
        StdDraw.setPenColor(StdDraw.WHITE);
        StdDraw.text(WIDTH / 2, HEIGHT / 2, "Directions: Go the mountains");
                    ...
                    case 'S':
                        if (current.y - 1 >= 0 && current.y - 1 < HEIGHT) {
                            ...
                            if (tileTwo.equals(Tileset.SAND)) {
                                ...
                                current.y = current.y - 1;
                                world[current.x][current.y] = Tileset.AVATAR;
                            } else if (tileTwo.equals(Tileset.MOUNTAIN)) {
                                return;
                            }
                        }
                        break;
                    case 'A':
                        if (current.x - 1 >= 0 && current.x - 1 < WIDTH) {
                            ...
                            if (tileThree.equals(Tileset.SAND)) {
                                ...
                                world[current.x][current.y] = Tileset.AVATAR;
                            } else if (tileThree.equals(Tileset.MOUNTAIN)) {
                                return;
                            }
                        }
                        break;
                    case 'D':
                        if (current.x + 1 >= 0 && current.x + 1 < WIDTH) {
                            ...
                            if (tileFour.equals(Tileset.SAND)) {
                                ...
                                current.x = current.x + 1;
                                world[current.x][current.y] = Tileset.AVATAR;
                            } else if (tileFour.equals(Tileset.MOUNTAIN)) {
                                return;
                            }
                        }
                        break;
    ...
    private void checkMouse(TETile[][] world) {
        ...
        StdDraw.text(WIDTH - 20, 2, name + ", GO TO THE MOUNTAINS");
        StdDraw.show();
        StdDraw.setFont(new Font("Monaco", Font.BOLD, 14));
    }
